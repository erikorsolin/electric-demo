...
export default function App() {
  const { isLoading, data } = useShape({
    url: process.env.REACT_APP_ELECTRIC_API_URL,
    params: {
      table: 'todos',
      columns: ['id', 'task', 'is_completed', 'created_at'],
      source_id: process.env.REACT_APP_ELECTRIC_SOURCE_ID,
      source_secret: process.env.REACT_APP_ELECTRIC_SOURCE_SECRET,
    },
  });
